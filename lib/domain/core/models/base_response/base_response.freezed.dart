...
abstract class $BaseResponseCopyWith<$Res> {
  ...
  $Res call({dynamic data, dynamic metadata, String message});
}
...
class _$_BaseResponse implements _BaseResponse {
  const _$_BaseResponse(
      {required this.data, this.metadata = null, required this.message});
  ...
  @override
  String toString() {
    return 'BaseResponse(data: $data, metadata: $metadata, message: $message)';
  }
